...
path = '/home/juannis/data-visualization-patterns/display-patterns/correlations/Pruebas'
lstFiles = []
lstFilesR=[]
...
archivo.write('{:30}'.format('File')+'{:>10}'.format('No. Libreria(s)')+"\n")
for l in lib:	
	archivo.write('{:30}'.format(l)+'{:>10}'.format(lib[l])+"\n")
